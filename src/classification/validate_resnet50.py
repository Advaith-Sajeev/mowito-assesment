...
def main(
        ...
        for inputs, labels, indices in val_loader:
            ...
            for ds_idx, p, t in zip(mismatch_indices, preds_mis, labels_mis):
                ...
                if p == bad_idx and t == good_idx:
                    ...
                    # other misclassification types shouldn't exist in binary case,
                    # but keep for safety
    ...
    ax.set_title(
        f"Confusion Matrix (Val)\nPrecision(bad)={precision_bad:.3f}, "
        f"Recall(bad)={recall_bad:.3f}"
    )
    ...
    cm_path = os.path.join(out_dir, "confusion_matrix_val.png")
    plt.tight_layout()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="best_resnet50.pth")
    parser.add_argument("--img_size", type=int, default=224)
    parser.add_argument("--batch_size", type=int, default=32)
    parser.add_argument("--num_workers", type=int, default=4)
    parser.add_argument("--out_dir", type=str, default="val_outputs")
